# Contributing to FeedGears

Welcome to FeedGears! We appreciate your interest and contributions.
...
2. Clone the forked repository to your local machine:
   ...
   ```bash
   git clone https://github.com/lostsidewalk/feedgears-client.git
   ```
